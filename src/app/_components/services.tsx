...
import {ChevronLeft, ChevronRight, Scissors, Syringe, CarTaxiFront, Hotel, Clock1} from 'lucide-react'
...
export function Services(){
    ...
    const[emblaRef, emblaApi] = userEmblaCarousel({
        loop: false,
        align: "start",
        slidesToScroll:1,
        breakpoints:{
            ...
            <div className=" container mx-auto px-4">
                <div>
                    ...
                    <div className="relative">
                            ...
                            <div className='flex'>
                                ...
                                {services.map((item, index) =>(
                                    <div className="flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3" key={index}>
                                        ...
                                        <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-5 h-full flex flex-col">
                                            ...
                                            <div className='border-t border-gray-700 pt-4 flex items-center justify-between'>
                                                ...
                                                <div className='flex itens-center gap-2 text-sm'>
                                                    ...
                                                    <a target='_blank'
                                                        href={`https://wa.me/556799998800?text=Olá vim pelo site e gostaria de mais informações sbore ${item.title}`} className='flex items-center justify-center gap-2 hover:bg-red-500 px-4 py-1 rounded-md duration-300'>
                        ...
                        <button onClick={scrollNext}  className=' w-10 h-10 bg-white flex items-center justify-center rounded-full shadow-lg absolute -right-6 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10'>
                            <ChevronRight 
                            className='w-6 h-6 text-gray-600'
                            />
                        </button>
